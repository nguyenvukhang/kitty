...
from alatty.fast_data_types import DECAWM, DECCOLM, DECOM, IRM, Cursor, parse_bytes
from alatty.marks import marker_from_function, marker_from_regex
from alatty.window import pagerhist
...
class TestScreen(BaseTest):
    ...
    def test_serialize(self):
        from alatty.window import as_text
        s = self.create_screen()
    ...
    def test_pointer_shapes(self):
        from alatty.window import set_pointer_shape
        s = self.create_screen()
        c = s.callbacks
        response = ''
