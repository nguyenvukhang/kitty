...
from alatty.key_encoding import EventType, KeyEvent, decode_key_event, encode_key_event
from alatty.keys import Mappings
...
# end legacy letter tests
    ...
    def test_mapping(self):
        ...
        from alatty.options.utils import parse_shortcut
        af = self.assertFalse
        ...
        # modal mappings
        tm = TM('map --new-mode mw --on-unknown end alatty_mod+f7', 'map --mode mw left neighboring_window left', 'map --mode mw right neighboring_window right')
