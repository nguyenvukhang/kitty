...
.. note::
   ...
   <https://github.com/ryanoasis/nerd-fonts/releases>`__). alatty should pick up
...
If your font is not listed in ``alatty +list-fonts`` it means that it is not
...
Then, the font will be available in ``alatty +list-fonts``.
