...
from alatty.cli import emph
from alatty.config import parse_config
from alatty.fast_data_types import Color, patch_color_profiles
...
if TYPE_CHECKING:
    from alatty.cli_stub import SetColorsRCOptions as CLIOptions
...
class SetColors(RemoteCommand):
    ...
    desc = (
        ...
        ' (in the same format as :file:`alatty.conf`) to read the colors from or you can specify individual colors,'
        ' for example::\n\n'
...
--configured -c
type=bool-set
Also change the configured colors (i.e. the colors alatty will use for new
windows or after a reset).


--reset
type=bool-set
Restore all colors to the values they had at alatty startup. Note that if you specify
