...
from alatty.fast_data_types import KeyEvent as WindowSystemKeyEvent
from alatty.fast_data_types import get_boss
from alatty.key_encoding import decode_key_event_as_window_system_key
from alatty.options.utils import parse_send_text_bytes
...
if TYPE_CHECKING:
    from alatty.cli_stub import SendTextRCOptions as CLIOptions
