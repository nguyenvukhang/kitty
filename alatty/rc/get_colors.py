...
from alatty.rgb import color_as_sharp, color_from_int
from alatty.utils import natsort_ints
...
if TYPE_CHECKING:
    from alatty.cli_stub import GetColorsRCOptions as CLIOptions
...
class GetColors(RemoteCommand):
    ...
    desc = (
        ...
        ' Colors will be output to STDOUT in the same syntax as used for :file:`alatty.conf`.'
