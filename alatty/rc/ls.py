...
if TYPE_CHECKING:
    from alatty.cli_stub import LSRCOptions as CLIOptions
...
class LS(RemoteCommand):
    ...
    desc = (
        ...
        ' running the command inside a alatty window, that window can be identified by the :italic:`is_self` parameter.\n\n'
