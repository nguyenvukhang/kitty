...
class SingleKey:
    ...
    def key(self) -> int: ...
    @property
    def defined_with_alatty_mod(self) -> bool: ...
    def __iter__(self) -> Iterator[int]: ...
    def _replace(self, mods: int = 0, is_native: object = False, key: int = -1) -> 'SingleKey': ...
    def resolve_alatty_mod(self, mod: int) -> 'SingleKey': ...
...
def mask_alatty_signals_process_wide() -> None: ...
