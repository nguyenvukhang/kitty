...
collapse_pua_space_ligature(index_type num_cells) {
    ...
    // so special case it: https://github.com/kovidgoyal/alatty/issues/1225
    g->num_glyphs = 1;
}
    ...
    for (i=0, first_cell_in_run=0; i < line->xnum; i++) {
        ...
        if (
            ...
            while (
                ...
                // for the space and the PUA. See for example: https://github.com/kovidgoyal/alatty/issues/467
