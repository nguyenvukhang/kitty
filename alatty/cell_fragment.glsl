#pragma alatty_include_shader <alpha_blend.glsl>
#pragma alatty_include_shader <linear2srgb.glsl>
#pragma alatty_include_shader <cell_defines.glsl>
...
float adjust_alpha_for_incorrect_blending_by_compositor(float text_fg_alpha, float final_alpha) {
    ...
    // See https://github.com/kovidgoyal/alatty/issues/6209 for discussion.
